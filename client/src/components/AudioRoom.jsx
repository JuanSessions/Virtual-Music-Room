          ...
          <div className="audioRoom-control">
            ...
            >
              <div className="audioRoom-control__knob">
                {isPlaying ? (
                  <i className="far fa-pause-circle audio-icon"></i>
                ) : (
                  <i className="far fa-play-circle audio-icon"></i>
                )}
              </div>
            </Draggable>
            ...
            <div
              style={{ transform: `scale(${vol1 + 0.5}, ${vol1 + 0.5})` }}
              className="audioRoom-control__avatar audioRoom-control__avatar--1"
            />
            <div
              style={{ transform: `scale(${vol2 + 0.5}, ${vol2 + 0.5})` }}
              className="audioRoom-control__avatar audioRoom-control__avatar--2"
            />
            <div
              style={{ transform: `scale(${vol3 + 0.5}, ${vol3 + 0.5})` }}
              className="audioRoom-control__avatar audioRoom-control__avatar--3"
            />
            <div
              style={{ transform: `scale(${vol4 + 0.5}, ${vol4 + 0.5})` }}
              className="audioRoom-control__avatar audioRoom-control__avatar--4"
            />
          </div>
        </div>
      </div>
